...
export const emailSubjects = {
  ...
  speakerSelectedConfirmation: (eventName: string) => eventSubject('Your presentation was selected for ', eventName),
  speakerProposalRejected: (eventName: string) => eventSubject('Update on your presentation proposal for ', eventName),
  ...
  communitySubmissionWithdrawn: (eventTitle: string) => eventSubject('Your event listing was removed: ', eventTitle),
...
export const EMAIL_SCENARIOS: ReadonlyArray<{
  ...
  { id: 'speaker_selected_confirmation', status: 'active', sender: 'speakers', recipient: 'selected speaker', subjectPattern: 'Your presentation was selected for {event name}' },
  { id: 'speaker_proposal_rejected', status: 'active', sender: 'speakers', recipient: 'speaker whose proposal was not selected', subjectPattern: 'Update on your presentation proposal for {event name}' },
  { id: 'speaker_archive_request', status: 'active', sender: 'speakers', recipient: 'past program presenter', subjectPattern: 'Share your talk resources: {event name}' },
  { id: 'speaker_archive_materials_follow_up', status: 'active', sender: 'speakers', recipient: 'published speaker with missing archive details', subjectPattern: 'Share your talk resources: {event name}' },
  ...
  { id: 'community_amendment_approved', status: 'active', sender: 'events', recipient: 'community event submitter', subjectPattern: 'Your event is now listed: {event title}' },
