...
.app-boot__eyebrow{margin:0 0 1rem;color:#e8117f;font-family:"IBM Plex Mono",ui-monospace,SFMono-Regular,Consolas,monospace;font-size:.65rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase}
.app-boot__title{max-width:12ch;margin:0;font-size:clamp(2.75rem,7vw,6.5rem);font-weight:900;letter-spacing:-.045em;line-height:.92}
