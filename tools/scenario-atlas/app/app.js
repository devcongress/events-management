...
app.addEventListener('click', async (event) => {
  ...
  try {
    ...
    else if (button.hasAttribute('data-theme-toggle')) { const next = document.documentElement.dataset.theme === 'dark' ? 'light' : 'dark';

 document.documentElement.dataset.theme = next; localStorage.setItem('scenario-atlas-theme', next); }
  } catch (error) {
