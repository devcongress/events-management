...
- **December 2026 annual-conference workspace and volunteer intake**
  ...
  - Organizer workspace: `/organizer-console/annual-conference/:year`, with an edition-scoped Work plan; Volunteers remains a 2026-specific compatibility workflow. Legacy Timeline links redirect to Work plan while retaining phase and task context. The workspace header uses one edition selector beside the Annual Conference label, places module navigation on its own row, and exposes future-edition creation as a secondary action.
