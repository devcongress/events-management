...
- the Overview replaces the Volunteer Intake callout with a compact workload view for Owners and Organizers: outstanding work is grouped once per accountable owner, matching legacy aliases against the active member directory where possible; selecting a person opens the full Work plan filtered to that person; volunteer sessions do not receive the team-wide view;
