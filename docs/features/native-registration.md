...
4. Open the event’s **Registration** tab. Its internal workspace is limited to **Summary**, **Guests**, **Form & Capacity**, and **Emails**.
5. Use **Summary** for going/capacity/places-left context, a waitlist only when overflow exists, check-in and cancellation counts, and no-shows only after the event has ended.
