...
- Use `EVENT_TEST_MODE=true` only for controlled organizer-created rehearsal events. Private-beta public submissions use the independent discovery gate and are not renamed.
