...
This folder keeps the README lightweight. Use this page to find the right level of detail without reading every document.

## For New Contributors

| Read | Why |
|---|---|
| [Product Operating Model](product-operating-model.md) | Understand what the product owns, which events and people it models, and where it is going |
...
| Read | Why |
|---|---|
| [Product Operating Model](product-operating-model.md) | Use the agreed domain and sequencing rules before changing schemas, roles, or public contracts |
| [Annual Conference Plan](annual-conference-plan.md) | Track what exists, what is planned, and which annual-conference decisions remain open |
